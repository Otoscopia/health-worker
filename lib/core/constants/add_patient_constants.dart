...
final FilteringTextInputFormatter nameFilter = FilteringTextInputFormatter.allow(RegExp(r'[a-zA-Z .]'));
final FilteringTextInputFormatter schoolIDFilter = FilteringTextInputFormatter.allow(RegExp(r'[0-9\-]'));
...
const String guardiansNameLabel = "Guardian Full Name";
const String guardiansPhoneLabel = "Guardian Contact Number";
...
const String guardiansPhonePlaceholder = "09XXXXXXXXX";
