...
import "package:health_worker/features/app/presentation/pages/right_camera.dart";
...
class _CameraState extends ConsumerState<LeftCamera> {
  ...
  moveFile(File sourceFile, String fileName) async {
    ...
    final String finalPath = "${newPath.path}\\left-$fileName";
    ...
    await encryptFileFunction(file, encrypter, 'left-$fileName');
  }
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  const Text("Left Ear").fontSize(24).bold(),
